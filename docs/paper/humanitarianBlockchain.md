...
<!-- Background around humanitarian aid
What is going on in this eco-system
Take care to link into the intro early on the title of the paper.
Problem statement
What is wrong with Humanitarian aid process currently, why do existing solutions not work?
Outline your aims and objectives
Aim to provide an innovative solution that will fulfill x, y, z, … objectives. -->
...
However, a blockchain is different from a traditional distributed database because it has far more capabilities. For instance, the consensus protocols of blockchains allow for the secure and seamless transfer of assets without relying upon any form of centralisation [@swan_blockchain:_2015]. Furthermore, the cryptographic capabilities of blockchains result in inherent confidentiality, integrity, authenticity and validity mechanisms [@Huckle_FakeNewsTechnological_2017]; indeed, blockchain's use of public-key cryptography means that, unlike any database, the technology includes a publicly auditable permission scheme.
