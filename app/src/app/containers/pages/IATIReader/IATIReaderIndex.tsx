...
export namespace IATIReaderIndex {
  export interface Props extends RouteComponentProps<void> {
  }
}

export class IATIReaderIndex extends React.Component<IATIReaderIndex.Props> {

  constructor(props: IATIReaderIndex.Props, context?: any) {
    super(props, context)
  }
