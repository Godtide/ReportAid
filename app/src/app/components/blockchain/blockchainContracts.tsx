      ...
      const contractData: ContractProps = {
        data: {
          contracts: {
            ...
            orgDocs: new ethers.Contract(Contract.organisationDocsAddress,
                                                     Contract.organisationDocsABI,
                                                     signer) as IATIOrganisationDocs,
            orgBudgets: new ethers.Contract(Contract.organisationBudgetsAddress,
                                                     Contract.organisationBudgetsABI,
                                                     signer) as IATIOrganisationBudgets,
            orgExpenditure: new ethers.Contract(Contract.organisationExpenditureAddress,
                                                     Contract.organisationExpenditureABI,
                                                     signer) as IATIOrganisationExpenditure,
            orgRecipientBudgets: new ethers.Contract(Contract.organisationRecipientBudgetsAddress,
                                                     Contract.organisationRecipientBudgetsABI,
                                                     signer) as IATIOrganisationRecipientBudgets,
            orgRegionBudgets: new ethers.Contract(Contract.organisationRegionBudgetsAddress,
                                                     Contract.organisationRegionBudgetsABI,
                                                     signer) as IATIOrganisationRegionBudgets,
            orgCountryBudgets: new ethers.Contract(Contract.organisationCountryBudgetsAddress,
