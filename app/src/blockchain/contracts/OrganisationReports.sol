...
contract OrganisationReports {
  ...
  function getReportingOrgExists(string _reference, string _orgRef) public view returns (bool);
  ...
  function getDefaultLang(string _reference, string _orgRef) public view returns (string);
  function getDefaultCurrency(string _reference,  string _orgRef) public view returns (string);
